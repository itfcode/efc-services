...
namespace ITFCode.Core.Infrastructure.EfCoreServices.Intrefaces
{
        ...
        where TKey3 : IEquatable<TKey3>
    {
        ...
        IEnumerable<TEntity> GetMany(IEnumerable<(TKey1, TKey2, TKey3)> keys, bool asNoTracking = true);
        Task<IEnumerable<TEntity>> GetManyAsync(IEnumerable<(TKey1, TKey2, TKey3)> keys, bool asNoTracking = true, CancellationToken cancellationToken = default);
    }
}