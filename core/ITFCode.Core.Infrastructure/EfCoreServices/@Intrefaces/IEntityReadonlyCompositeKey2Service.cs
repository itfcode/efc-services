...
namespace ITFCode.Core.Infrastructure.EfCoreServices.Intrefaces
{
        ...
        where TKey2 : IEquatable<TKey2>
    {
        ...
        IEnumerable<TEntity> GetMany(IEnumerable<(TKey1, TKey2)> keys, bool asNoTracking = true);
        Task<IEnumerable<TEntity>> GetManyAsync(IEnumerable<(TKey1, TKey2)> keys, bool asNoTracking = true, CancellationToken cancellationToken = default);
    }
}