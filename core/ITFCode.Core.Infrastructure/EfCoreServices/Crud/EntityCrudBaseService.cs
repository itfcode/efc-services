...
namespace ITFCode.Core.Infrastructure.EfCoreServices.Crud
{
        ...
        where TEntity : class, IEntity
    {
        ...
        //public static IQueryable<T> FilterByMulticolumnId<T, TId1, TId2>(this IQueryable<T> queriable, IEnumerable<(TId1, TId2)> ids, params string[] pkPropertyNames)
        //{
        //    if (pkPropertyNames.Length != 2)
        //    {
        //        throw new ArgumentOutOfRangeException("Number of PK property names is not 2");
        //    }
