...
namespace ITFCode.Core.Infrastructure.EfCoreServices.Crud
{
        ...
        where TKey2 : IEquatable<TKey2>
    {
        ...
        public virtual IEnumerable<TEntity> GetMany(IEnumerable<(TKey1, TKey2)> keys, bool asNoTracking = true)
        {
            throw new NotImplementedException();
        }

        public virtual async Task<IEnumerable<TEntity>> GetManyAsync(IEnumerable<(TKey1, TKey2)> keys, bool asNoTracking = true, CancellationToken cancellationToken = default)
        {
            throw new NotImplementedException();
        }
        ...
        public async Task DeleteAsync(TKey1 key1, TKey2 key2, bool shouldSave = false, CancellationToken cancellationToken = default)
        ...
        public async Task DeleteRangeAsync(IEnumerable<(TKey1, TKey2)> keys, bool shouldSave = false, CancellationToken cancellationToken = default)
