...
namespace ITFCode.Core.Infrastructure.EfCoreServices.Readonly
{
        ...
        where TKey2 : IEquatable<TKey2>
    {
        ...
        public IEnumerable<TEntity> GetMany(IEnumerable<(TKey1, TKey2)> keys, bool asNoTracking = true)
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<TEntity>> GetManyAsync(IEnumerable<(TKey1, TKey2)> keys, bool asNoTracking = true, CancellationToken cancellationToken = default)
        {
            throw new NotImplementedException();
        }
